...
g.add((dbr.Novigrad_and_Velen_Map, OWL.sameAs, dbr.Velen_Novigrad_Map))  # Link the two map concepts
g.add((dbr.Velen_Novigrad_Map, OWL.sameAs, dbr.Novigrad_and_Velen_Map))
...
g.add((witcher.Blacksmiths, OWL.sameAs, witcher.Blacksmith))
...
g.add((witcher.Armorers, OWL.sameAs, witcher.Armorer))          
...
g.add((witcher.The_Witcher_3_notice_boards, OWL.sameAs, witcher.NoticeBoard))
...
g.add((witcher.The_Witcher_3_secondary_quests, OWL.sameAs, witcher.SideQuest))
...
g.add((witcher.The_Witcher_3_treasure_hunts, OWL.sameAs, witcher.TreasureQuest))
...
# Again connecting the Conceptual Roads entity to the Geospatial Road class
g.add((witcher.Road, OWL.sameAs, witcher.Roads))
g.add((witcher.Roads, OWL.sameAs, witcher.Road))
