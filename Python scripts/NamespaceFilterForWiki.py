...
# output_dir = '../Wiki_Dump_Namespaces/'
...
# # Define the namespaces you want to extract (e.g., main namespace (0), user namespace (2), etc.)
# target_namespaces = {0, 4, 14, 420, 290}  # Add or remove keys as needed
